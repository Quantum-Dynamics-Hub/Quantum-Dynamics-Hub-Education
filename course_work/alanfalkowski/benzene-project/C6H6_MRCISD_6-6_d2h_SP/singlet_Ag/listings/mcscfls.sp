 ...
 *** Starting integral transformation ***
 ...
 !timer: 2-e transformation              cpu_time=     2.594 walltime=     6.691
 ...
 ***  micro: final psci convergence values:  ***
 ...
 !timer: mcscf iteration                 cpu_time=     2.689 walltime=     7.101
 ...
 !timer:                                 cpu_time=     2.696 walltime=     7.239
 ...
 *** Starting integral transformation ***
 ...
 !timer: 2-e transformation              cpu_time=     0.806 walltime=     0.835
 ...
 ***  micro: final psci convergence values:  ***
 ...
 restrt: restart information saved on the restart file (unit= 13).
 !timer: mcscf iteration                 cpu_time=     0.895 walltime=     1.265
 ...
 !timer: mcscf                           cpu_time=     3.613 walltime=     8.609
 *** cpu_time / walltime =      0.420
